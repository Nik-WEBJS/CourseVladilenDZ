...
console.log("const:", bestProgrammingLanguage1,"“Переменную с const переопределить нельзя”", typeof bestProgrammingLanguage1);
console.log("const:", bestProgrammingLanguage2,"“Переменную с const переопределить нельзя”", typeof bestProgrammingLanguage2);
...
console.log("var:", isJavaScriptProgrammer1, "var является устаревшим");
console.log("var:", isJavaScriptProgrammer2, "var является устаревшим");
